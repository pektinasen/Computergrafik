...
public final class SimpleMaterial implements Material {
	 ...
	 * 
	 * @param arcr ambient reflection coefficient, 'red' component
	 * @param arcg ~ ~ ~, 'green' component
	 * @param arcb ~ ~ ~, 'blue' component
	 * @param drcr diffuse reflection coefficient, 'red' component
	 * @param drcg ~ ~ ~, 'green' component
	 * @param drcb ~ ~ ~, 'blue' component
	 * @param src specular reflection coefficient
	 * @param sn specular power constant
	 */
	public SimpleMaterial(final double arcr, final double arcg, final double arcb, final double drcr, final double drcg, final double drcb, final double src, final double sn) {
